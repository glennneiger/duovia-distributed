...
{
    partial class DistServiceInstaller
    {
        /// <summary>
        ...
        private string serviceName = "DistService";
        private string serviceDescription = "Service host for DuoVia Distributed Host";
        private string serviceDisplayName = "DuoVia Distributed Host Service";
